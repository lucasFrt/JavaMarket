...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        NomeCad.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        EmailCad.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel5.setText("Usuario:");

        UsuarioCad.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel6.setText("Senha:");

        SenhaCad.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel7.setText("Cargo:");

        jComboBox1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Gerente", "Caixa", "Estoquista" }));

        BotaoCadastrar.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        BotaoCadastrar.setText("Gravar Cadastro");
        ...
        jLabel8.setText("Já tem cadastro?");

        irLogin.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        irLogin.setForeground(new java.awt.Color(255, 51, 51));
        irLogin.setText("Fazer Login!");
    ...
    private void BotaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCadastrarActionPerformed
        ...
        String strCampoUser = UsuarioCad.getText();
        String strCampoSenha = SenhaCad.getText();
    }                                              

    private boolean validaCamposObrigatorios() {
        return (NomeCad.getText().equals("")
                || EmailCad.getText().equals("")
                || UsuarioCad.getText().equals("")
                || SenhaCad.getText().equals(""));
    }
    private void Salvar_Dados() throws Exception{
        if(validaCamposObrigatorios()) {
            ...
            try {
                ...
                cliente.setEmail(EmailCad.getText());
                cliente.setSenha(SenhaCad.getText());
                cliente.setUsuario(UsuarioCad.getText());
               
                cadastrodao.adicionar(cliente);
